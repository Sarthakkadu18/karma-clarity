...
const features = [
  {
    ...
    description: 'Access profound teachings from sacred texts including Bhagavad Gita, Quran, Bible, Chanakya Niti, Guru Granth Sahib, Dhammapada, and Tao Te Ching.'
  },
  {
    icon: Brain,
